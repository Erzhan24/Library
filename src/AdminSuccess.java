...
public class AdminSuccess extends JFrame {
	...
	public AdminSuccess() {
		...
		JButton btnViewLibrarian = new JButton("View Readers");
		...
		JButton btnLibrarian = new JButton("Find Reader");
		btnLibrarian.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				FindReader.main(new String[]{});
			}
		});
		...
		btnBook.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				FindBook.main(new String[]{});
				frame.dispose();
			}
		});
		btnBook.setFont(new Font("Tahoma", Font.PLAIN, 15));
		
		JButton btnDeleteLibrarian = new JButton("Delete Reader");
		...
		JButton btnNewBookButton = new JButton("Add Books");
		btnNewBookButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				BooksForm.main(new String[]{});
				frame.dispose();
			}
		});
		btnNewBookButton.setFont(new Font("Tahoma", Font.PLAIN, 15));
			...
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						...
						.addComponent(btnNewBookButton, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnDeleteLibrarian, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
							.addComponent(btnBook, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
							.addComponent(btnLibrarian, GroupLayout.PREFERRED_SIZE, 181, GroupLayout.PREFERRED_SIZE)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(18)
						.addComponent(btnLibrarian, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE)
						.addGap(18)
						.addComponent(btnBook, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE)
						.addGap(18)
					.addComponent(btnDeleteLibrarian, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
					.addComponent(btnNewBookButton, GroupLayout.PREFERRED_SIZE, 49, GroupLayout.PREFERRED_SIZE)
					.addGap(18)
