...
public class AdminLogin extends JFrame {
	...
	public AdminLogin() {
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			if(name.equals("Тетя Галя")&&password.equals("123")){
				AdminSuccess.main(new String[]{});
				frame.dispose();
			}else{
				JOptionPane.showMessageDialog(AdminLogin.this, "Tetya Galya zabyla svoi parol","Login Error!", JOptionPane.ERROR_MESSAGE);
				textField.setText("");
