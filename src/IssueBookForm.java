...
public class IssueBookForm extends JFrame {
	...
	public IssueBookForm() {
		...
		JLabel lblBookName = new JLabel("Book Mark:");
		...
		btnIssueBook.addActionListener(new ActionListener() {
			...
			if(i>0){
				JOptionPane.showMessageDialog(IssueBookForm.this,"Tetya Galya odobrila!");
				LibrarianSuccess.main(new String[]{});
				frame.dispose();
				
			}else{
				JOptionPane.showMessageDialog(IssueBookForm.this,"Sorry, Tetya Galya zlitsya!");
			}
			
			}else{
				JOptionPane.showMessageDialog(IssueBookForm.this,"Sorry, Mark doesn't exist!");
			}
